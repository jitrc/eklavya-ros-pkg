...
#SRC = EklavyaThreaded.cpp ./Modules/IMU/IMU.cpp ./Modules/Nav/Planner.cpp ./Utils/SerialPortLinux/serial_lnx.cpp ./Modules/Lidar/LidarData.cpp
SRC = AGV.cpp ./Modules/IMU/IMU.cpp ./Modules/Nav/Planner.cpp ./Utils/SerialPortLinux/serial_lnx.cpp ./Modules/Lidar/LidarData.cpp ./Modules/GPS/GPS.cpp ./Modules/Lane/Lane.cpp
